(define-library (scm-checker checkers)
  (import (scheme base)
          ...
          (prefix (scm-checker check-component define) chk-define/)
          ...
          (prefix (scm-checker check-component list) chk-list/)
      ...
      (case (car code)
        ...
        ((let)
         (append (chk-let/check-let code debug-info)
                 (handle-list code debug-info)))
        ((define)
         (append (chk-define/check-define code debug-info)
                 (handle-list code debug-info)))
        ((let*)
         (append (chk-let/check-let* code debug-info)
                 (handle-list code debug-info)))
        ...
        ((=)
         (append (chk-arithmetic/check-= code debug-info)
                 (chk-list/check-list-for-= code debug-info)
                 (handle-list code debug-info)))
        ((zero?)
